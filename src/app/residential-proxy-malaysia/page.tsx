  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-200">
      ...
      <main className="max-w-4xl mx-auto px-4 py-20">
        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">Residential Proxy Malaysia — Real ISP IPs for Any Use Case</h1>
        <p className="text-lg text-slate-400 mb-8 max-w-xl">Malaysian residential proxy from real mobile carriers. Physical 4G/5G modems, genuine carrier ASNs, unlimited bandwidth.</p>
