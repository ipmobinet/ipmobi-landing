  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-200">
      ...
      <main className="max-w-4xl mx-auto px-4 py-20">
        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">SOCKS5 Proxy Malaysia — High Speed Mobile Proxy Protocol</h1>
        <p className="text-lg text-slate-400 mb-8 max-w-xl">SOCKS5 proxy from Malaysia with dedicated 4G/5G mobile IPs. Low latency, unlimited bandwidth, API rotation.</p>
