  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-200">
      ...
      <main className="max-w-4xl mx-auto px-4 py-20">
        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">Malaysian Mobile Proxy — Dedicated 4G/5G IPs from Shah Alam</h1>
        <p className="text-lg text-slate-400 mb-8 max-w-xl">Get a dedicated Malaysian mobile proxy with real 4G/5G hardware. Physical modems with Maxis, Celcom & Digi SIMs in Shah Alam. Unlimited bandwidth, API rotation.</p>
