  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-200">
      ...
      <main className="max-w-4xl mx-auto px-4 py-20">
        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">Cheap Proxy Malaysia — Best Value Mobile Proxy $65/mo</h1>
        <p className="text-lg text-slate-400 mb-8 max-w-xl">Cheap but reliable Malaysian mobile proxy. Only $65/month for a dedicated physical 4G/5G modem. Unlimited bandwidth. Free trial.</p>
