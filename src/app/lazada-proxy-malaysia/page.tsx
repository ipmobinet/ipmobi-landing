  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-200">
      ...
      <main className="max-w-4xl mx-auto px-4 py-20">
        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">Lazada Proxy Malaysia — Multi-Account E-commerce Solution</h1>
        <p className="text-lg text-slate-400 mb-8 max-w-xl">Lazada Malaysia proxy service for managing multiple seller accounts. Dedicated 4G/5G mobile IPs, no sharing, unlimited bandwidth.</p>
