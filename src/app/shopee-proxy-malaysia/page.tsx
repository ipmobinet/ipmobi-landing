  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-200">
      ...
      <main className="max-w-4xl mx-auto px-4 py-20">
        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">Shopee Proxy Malaysia — Manage Multiple Seller Accounts Safely</h1>
        <p className="text-lg text-slate-400 mb-8 max-w-xl">Shopee seller proxy for managing multiple accounts without cross-account banning. Real Malaysian mobile IPs, dedicated modems, unlimited bandwidth.</p>
